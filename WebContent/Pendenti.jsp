<%@page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(categorie == null) {
		response.sendRedirect("./home?page=Pendenti.jsp");	
		return;
	}
%>
<!DOCTYPE html>
...
<body>
	...
	<%
	ArrayList<ProdottoBean> pendenti = categorie.get(3);%>
	...
	<h2>PENDENTI</h2>
		...
		<%
			if (pendenti != null && pendenti.size() != 0) {
				Iterator<?> it = pendenti.iterator();
				while (it.hasNext()) {
		...
		<div class="item">
			...
			<li><a href="carrello?action=addC&id=<%=bean.getIdProdotto()%>&page=Pendenti.jsp"><button>Aggiungi al carrello</button></a></li>
		 </ul>
		</div>
		<%
				}
