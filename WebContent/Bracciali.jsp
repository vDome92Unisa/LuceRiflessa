...
<body>
	...
	<%
	ArrayList<ProdottoBean> bracciali = categorie.get(1);%>
	...
	<h2>BRACCIALI</h2>
		...
		<div class="item">
			...
			<li><a href="carrello?action=addC&id=<%=bean.getIdProdotto()%>&page=Bracciali.jsp"><button>Aggiungi al carrello</button></a></li>
		 </ul>
		</div>
		<%
				}
