...
<body>
	...
	<%
	ArrayList<ProdottoBean> anelli = categorie.get(2);%>
	...
	<h2>ANELLI</h2>
		...
		<div class="item">
			...
			<li><a href="carrello?action=addC&id=<%=bean.getIdProdotto()%>&page=Anelli.jsp"><button>Aggiungi al carrello</button></a></li>
		 </ul>
		</div>
		<%
				}
